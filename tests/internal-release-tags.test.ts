...
test("selects changed internal versions and never tags the aggregate product", () => {
  expect(
    selectInternalTags(
      {},
      { ".": "0.0.0", "src/domain": "0.0.0", "src/presentation/cli": "0.0.0" },
    ),
  ).toEqual([]);
  expect(
    selectInternalTags(
      {
        ".": "0.0.0",
        "src/domain": "0.0.0",
        "src/application": "0.1.0",
        "src/presentation/cli": "0.0.0",
        "src/presentation/mcp": "0.0.0",
      },
      {
        ".": "0.1.0",
        "src/domain": "0.1.0",
        "src/application": "0.1.0",
        "src/presentation/cli": "0.1.0",
        "src/presentation/mcp": "0.2.0",
      },
    ),
