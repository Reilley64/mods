...
Multi-context repo, marked by `CONTEXT-MAP.md` at the root:
...
If the glossary doesn't contain the concept, reconsider whether you're inventing language the project doesn't use. If the concept represents a real gap, note it for `/domain-modeling`.

## Flag ADR conflicts

If your output contradicts an existing ADR, state that instead of silently overriding it:
