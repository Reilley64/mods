...
export const calibrationCases: CalibrationCase[] = [
	...
	},
	{
		...
		referencingFiles: ["application/src/installation/install_archive.rs"],
		before: "",
		after: "pub(super) fn evaluate(installer: &FomodInstaller) -> Evaluation {\n\tlet ordered_groups = order_groups(&installer.groups);\n\tlet required_options = collect_required_options(&ordered_groups);\n\tEvaluation::new(ordered_groups, required_options)\n}\n",
	},
	{
		...
		expectedViolation: true,
		ruleId: "application-use-cases-and-ports-use-case-local-implementation-modules",
		path: "application/src/installation/archive_plan.rs",
		referencingFiles: [
			"application/src/installation/install_archive.rs",
			"application/src/installation/mod.rs",
		],
...
`,
	},
	{
		...
		expectedViolation: false,
		ruleId: "application-use-cases-and-ports-use-case-local-implementation-modules",
		path: "application/src/installation/install_archive.rs",
		referencingFiles: ["application/src/installation/mod.rs"],
...
`,
...

	{
		...
		expectedViolation: true,
		ruleId: "application-use-cases-and-ports-use-case-local-implementation-modules",
		path: "application/src/installation/archive_selection.rs",
		referencingFiles: [
			"application/src/installation/install_archive.rs",
			"application/src/installation/mod.rs",
		],
...
`,
	},
	{
		...
		expectedViolation: false,
		ruleId: "application-use-cases-and-ports-use-case-local-implementation-modules",
		path: "application/src/installation/types.rs",
		referencingFiles: [
			"application/src/installation/install_archive.rs",
			"application/src/installation/mod.rs",
		],
...
`,
...

	{
		...
		expectedViolation: true,
		ruleId: "application-use-cases-and-ports-use-case-local-implementation-modules",
		path: "application/src/game/file_version.rs",
		referencingFiles: ["application/src/game/mod.rs", "application/src/game/synchronize.rs"],
		before: "",
...
`,
	},
	{
		...
		expectedViolation: false,
		ruleId: "application-use-cases-and-ports-use-case-local-implementation-modules",
		path: "infrastructure/game_platform/src/file_version.rs",
		referencingFiles: [
			"infrastructure/game_platform/src/adapter.rs",
			"infrastructure/game_platform/src/lib.rs",
		],
		before: "",
